...
AKS Automatic; [ADR-019](decisions/019-aks-base-node-autoprovisioning.md)
...
| **Application Insights** | Per-service request, dependency, and exception telemetry ([ADR-021](decisions/021-application-insights-telemetry.md)) |
...
See [ADR-019](decisions/019-aks-base-node-autoprovisioning.md) and
